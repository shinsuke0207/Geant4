...
LensPhysicalVolume = 
 ...
 logicalGroove->SetVisAttributes(boxVisAtt_blue); 
...
G4double UltraFresnelLens::GetSagita(G4double radius) 
{
  ...
  G4double Conic = -1.0;//放物面
  //G4double Conic = 0;
  //G4double Curvature = 0.00437636761488/mm ;
  //G4double Curvature = 0.00137636761488/mm ;
  G4double Curvature = 0.00047636761488/mm ;    
  //G4double Curvature = 1/(LensDiameter/2); //半径の逆数
